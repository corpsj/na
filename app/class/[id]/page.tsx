                    ...
                    <div className="bg-black/80 backdrop-blur-md border border-gray-800 mb-24">
                        <div className="grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-gray-800">
                            <div className="p-8 text-left group hover:bg-white/5 transition-colors duration-300">
                                <h3 className="text-primary text-xs md:text-sm font-bold tracking-[0.2em] uppercase mb-3 opacity-80 group-hover:opacity-100 transition-opacity">일시</h3>
                            ...
                            <div className="p-8 text-left group hover:bg-white/5 transition-colors duration-300">
                                <h3 className="text-primary text-xs md:text-sm font-bold tracking-[0.2em] uppercase mb-3 opacity-80 group-hover:opacity-100 transition-opacity">장소</h3>
                                <p className="text-white text-lg font-serif">{classDetail.location}</p>
                            </div>
                            <div className="p-8 text-left group hover:bg-white/5 transition-colors duration-300">
                                <h3 className="text-primary text-xs md:text-sm font-bold tracking-[0.2em] uppercase mb-3 opacity-80 group-hover:opacity-100 transition-opacity">난이도 및 정원</h3>
                            ...
                            <div className="p-8 text-left group hover:bg-white/5 transition-colors duration-300">
                                <h3 className="text-primary text-xs md:text-sm font-bold tracking-[0.2em] uppercase mb-3 opacity-80 group-hover:opacity-100 transition-opacity">수강료</h3>
